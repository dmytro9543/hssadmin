...
@section('user_js')
    <script src="/js/admin/adminhistory.js"></script>
@endsection
@section('content')
        ...
        <div class="page-content">
            <div class="container">
                ...
                <ul class="page-breadcrumb breadcrumb">
                  <li>
                        <font size="5" color="red">Log</font>
                  </li>
                </ul>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        @include('admin.adminHistorySearch')
                    </div>
                </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption" style="margin-top: 8px">
                                        <i class="fa fa-globe"></i>Log</div>
                                    <div class="tools">
                                    <button class="btn btn-success mt-ladda-btn ladda-button btn-circle" onclick="reset();"> Format
                                    </button>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <form action="/adminHistory" method="get" id="data_size">
                                    Rows:
                                    ...
                                    <div id="table_content">
                                        @include('admin.adminhistorycontent')
                                    </div>
                            </div>
