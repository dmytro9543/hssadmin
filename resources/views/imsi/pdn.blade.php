...
@section('user_js')
    <script src='/js/imsi/pdn.js'></script>
</script>
@endsection
@section('content')
        ...
        <div class="page-content">
            <div class="container">
                ...
                <ul class="page-breadcrumb breadcrumb">
                    <li>
                           <font size="5" color="red">PDN Management</font>
                    </li>
                </ul>
                ...
                <div class="page-content-inner">
                    ...
                    <div class="portlet-title">
                        <div class="caption" style="margin-top: 8px">
                            <i class="fa fa-globe"></i>PDN List
                        </div>
                        <div class="tools">
                        @if($permInfo[2]->perm_upd == 1)
                        <input type="button" class="btn red-sunglo" value="Add" onclick="showPdnModal(0);" href="#">
                        @endif
                        </div>
                    </div>
                    <div class="portlet-body">
                        <form action="/pdn" method="get" id="data_size">
                        Rows:
                        ...
                        <div id="table_content">
                             @include('imsi.pdncontent')
                        </div>
                    </div>

                    </div>
                    </div>
                    @include('imsi.pdnmodal')
