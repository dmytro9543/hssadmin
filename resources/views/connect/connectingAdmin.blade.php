        ...
        <div class="page-content">
            <div class="container">
                ...
                <ul class="page-breadcrumb breadcrumb">
                  <li>
                        <font size="5" color="red" id="title">User Online</font>
                  </li>
                </ul>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                     @include('connect.connectingAdminSearchInfo')
                    </div>
                </div>
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption" style="margin-top: 8px">
                                        <i class="fa fa-globe"></i>User Online List</div>
                                    <div class="tools">                
                                ...
                                <div class="portlet-body">
                                    ...
                                    <div id="table_content">
                                         @include('connect.connectingAdminContent')
                                    </div>
                            </div>
